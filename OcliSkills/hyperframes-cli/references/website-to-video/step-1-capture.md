...
### 🍎 Minis (iOS) Alternative — Use browser_use instead of CLI

`npx hyperframes capture` requires a local Node.js + Puppeteer environment. In Minis, use `browser_use` tool calls directly — equivalent output, no CLI needed.
